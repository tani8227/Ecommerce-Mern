...
export default function CoolerImgDisplayComponent(props) {
                    ...
                    >
                        ...
                        >
                            ...
                            <CardActions sx={{ display: "flex", flexDirection: { xs: "row", sm: "row" }, alignItems: { xs: "center" }, justifyContent: { sm: "center" } }}>
                                ...
                                <Button variant='contained' sx={{ backgroundColor: "#ff9f00",fontSize:"small" }} onClick={()=>{addToCard('Appliances',props.ProductCategory, data._id, 'cartpreview')}}>
