...
export default function ImgDisplayComponent(props) {
    ...
    function addToCard(mainCategory, schemaCollectionName, prodId, type) {
           console.log(mainCategory, schemaCollectionName, prodId, type);
                ...
                >
                    ...
                    >
                        ...
                        <CardActions sx={{ display: "flex", flexDirection: { xs: "row", sm: "row" }, alignItems: { xs: "center" }, justifyContent: { sm: "center" } }}>
                            ...
                            <Button variant='contained' sx={{ backgroundColor: "#ff9f00",fontSize:"small" }} onClick={() => { addToCard('Appliances', props.ProductCategory, data && data._id, 'cartpreview') }}>
