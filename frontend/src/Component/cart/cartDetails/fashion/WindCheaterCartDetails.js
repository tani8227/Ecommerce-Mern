...
export default function WindCheaterCartDetails(props) {
...
<Box>
      {cartItem&&cartItem.companyName&&
        <Item square elevation={0}  >
            ...
            {`${cartItem.companyName} ${cartItem.series} ${cartItem.displaySize} ${cartItem.hdTechnology} ${cartItem.screenType}`}
            </Typography>
