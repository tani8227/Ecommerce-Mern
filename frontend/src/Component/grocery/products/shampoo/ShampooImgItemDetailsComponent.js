...
export default function ImgItemDetailsComponent(props) {
    ...
    if(props.product.product.companyName===undefined)
        {
            ...
            <Grid container padding={0} >
                <Grid item xs={12} sx={{ display: "flex", flexDirection: "column", }}  >
                    <Item square elevation={0}  >
                        ...
                        {`${props.product.product.companyName} ${props.product.product.gender} ${props.product.product.capacity} ${props.product.product.containerType!==''||undefined?props.product.product.containerType:''}`}
                        </Typography>
                            ...
                            <Typography variant='h6' color={'grey'} sx={{ padding: 0, margin: 0, fontWeight: 500 }} >
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                        {`${props.product.product.hairType}`}
                                    </Typography>

                                </ListItem>
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                    {`${props.product.product.appliedFor!==''?props.product.product.appliedFor:''} `}
                                    </Typography>
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                    {`${props.product.product.capacity!==''?props.product.product.capacity:''} `}
                                    </Typography>
