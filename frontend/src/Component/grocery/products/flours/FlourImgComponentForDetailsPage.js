...
export default function FlourImgComponentForDetailsPage(props) {
                            ...
                            <Link to={`/Grocery/${props.ProductCategory}/${ele._id}`} style={{ textDecoration: "none" }} >
                                <Item square elevation={0}  >
                                    <Typography variant='h6' color={'black'} sx={{ padding: 0, margin: 0, textAlign: "left" }} >
                                        {`${ele.companyName} ${ele.modelName} ${ele.modelName}`}
                                    </Typography>
                                    ...
                                    <List sx={{ padding: 0, marginTop: 2 }}>
                                        ...
                                        <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                            <Typography variant='body2' color={"black"}>
                                                {`${ele.maximumShelfLife} ShelfLife`}
                                            </Typography>
                                        </ListItem>
