...
export default function FlourBrandList(props) {
  ...
  return (
    <FormGroup>
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="AASHIRVAAD" />}
        label="AASHIRVAAD"
      />
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="PILLSBURY" />}
        label="PILLSBURY"
      />
      <FormControlLabel
      ...
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="PATANJALI" />}
        label="PATANJALI"
      />
