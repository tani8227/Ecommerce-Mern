...
export default function OralCareBrandList(props) {
  ...
  return (
    <FormGroup>
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="Closeup" />}
        label="Closeup"
      />
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="Colgate" />}
        label="Colgate"
      />
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="Sensodyne" />}
        label="SENSODYNE"
      />
      <FormControlLabel
        control={<Checkbox onChange={getCheckBoxValue} name="Dabur" />}
        label="Dabur"
      />
