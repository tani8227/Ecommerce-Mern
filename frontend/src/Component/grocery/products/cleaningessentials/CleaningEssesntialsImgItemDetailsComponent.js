...
export default function CleaningEssesntialsImgItemDetailsComponent(props) {
                ...
                <Grid item xs={12} sx={{ display: "flex", flexDirection: "column", }} >
                    <Item square elevation={0}  >
                        <Typography variant='h6' color={'black'} sx={{ padding: 0, margin: 0 }} >
                            ...
                            {`${props.product.product.companyName} ${props.product.product.useFor} ${props.product.product.type}`}
                        </Typography>
                        ...
                        <List  sx={{ padding: 0, margin: 0 }}>
                            <Typography variant='h6' color={'grey'} sx={{ padding: 0, margin: 0, fontWeight: 500 }} >
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                        {`${props.product.product.useFor} ${props.product.product.type }`}
                                    </Typography>
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc' }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                    {`${props.product.product.fragrance===''||props.product.product.fragrance===undefined?'':props.product.product.fragrance} `}
                                    </Typography>

                                </ListItem>
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                        {`${props.product.product.packOf===''||props.product.product.packOf===undefined?'':props.product.product.packOf} Pack `}
                                    </Typography>
