...
export default function CleaningEssesntialsImgDisplayComponent(props) {
    ...
    const handleClick = () => {
     if (!isClicked) {
       ...
       handleAddToCart('Grocery',props.ProductCategory, props.id, 'orderpreview');
       setIsClicked(true);
     }
   };
                    ...
                    >
                        ...
                        >
                            ...
                            <CardActions sx={{ display: "flex", flexDirection: { xs: "row", sm: "row" }, alignItems: { xs: "center" }, justifyContent: { sm: "center" } }}>
                                ...
                                <Button variant='contained' sx={{ backgroundColor: "#ff9f00",fontSize:"small" }} onClick={()=>{addToCard('Grocery',props.ProductCategory, data._id,'cartpreview')}}>
