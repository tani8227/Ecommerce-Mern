...
export default function CleaningEssesntialsImgComponentForDetailsPage(props) {
                                    ...
                                    <Card square elevation={0} sx={{ width: { xs: "100%", } }}>
                                        <ThemeProvider theme={theme}>
                                            <CardMedia className='xs-phone-width'
                                                component="img"
                                                sx={{ margin: 'auto',minWidth:"100px", maxWidth: "180px", maxHeight: "180px", objectFit: "contain" }}
                            ...
                            <Link to={`/Grocery/${props.ProductCategory}/${ele._id}`} style={{ textDecoration: "none" }} >
                                <Item square elevation={0}  >
                                    <Typography variant='h6' color={'black'} sx={{ padding: 0, margin: 0, textAlign: "left" }} >
                                        {`${ele.companyName} ${ele.useFor} ${ele.type}`}
                                    </Typography>
