...
export default function TrackPantImgComponentForDetailsPage(props) {
                            ...
                            <Link to={`/Fashion/${props.ProductCategory}/${ele._id}`} style={{ textDecoration: "none" }} >
                                <Item square elevation={0}  >
                                    <Typography variant='h6' color={'black'} sx={{ padding: 0, margin: 0, textAlign: "left" }} >
                                        {`${ele.companyName} ${ele.gender} ${ele.pattern} ${ele.color} Track Pant`}
                                    </Typography>
                                    ...
                                    <List sx={{ padding: 0, marginTop: 2 }}>
                                        ...
                                        <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                            <Typography variant='body2' color={"black"}>
                                            {`${ele.size==='M'?'Medium':''}${ele.size==='S'?'Small':''}${ele.size==='L'?'Large':''} Size`}
                                            </Typography>
                                        </ListItem>
                                        ...
                                        <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                            <Typography variant='body2' color={"black"}>
                                               {`${ele.packOf!==''?`${ele.packOf} Pack Of Track Pant` :''}`}
                                            </Typography>
                                        </ListItem>
