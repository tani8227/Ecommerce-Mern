                ...
                <Grid item xs={12} sx={{ display: "flex", flexDirection: "column", }} >
                    <Item square elevation={0}  >
                        <Typography variant='h6' color={'black'} sx={{ padding: 0, margin: 0 }} >
                            ...
                            {`${props.product.product.companyName} ${props.product.product.gender} ${props.product.product.pattern} ${props.product.product.color} Track Pant`}
                        </Typography>
                            ...
                            <Typography variant='h6' color={'grey'} sx={{ padding: 0, margin: 0, fontWeight: 500 }} >
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                        {`${props.product.product.fabric} Fabric`}
                                    </Typography>

                                </ListItem>
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                        {`${props.product.product.size==='M'?'Medium':''}${props.product.product.size==='S'?'Small':''}${props.product.product.size==='L'?'Large':''} Size`}
                                    </Typography>
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                        {`${props.product.product.color} Color`}
                                    </Typography>
                                ...
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc' }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>
                                    {`${props.product.product.packOf!==''?`${props.product.product.packOf} Pack Of Track Pant` :''}`}
                                    </Typography>

                                </ListItem>
                                <ListItem sx={{ padding: 0, margin: 0, display: 'list-item', listStyleType: 'disc', }}>
                                    <Typography variant='body2' sx={{ color: "black" }}>      
                                    {`${props.product.product.fabricCare!==''?props.product.product.fabricCare:''}`}
                                    </Typography>
