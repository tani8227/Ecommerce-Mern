...
export default function AddCleaningEssentials(props) {
    ...
    async function handlesubmit(e) {
        ...
        try {
            ...
            if (defaultVal) {
                ...
                const response = await fetch(`${process.env.REACT_APP_BACKEND_APP_API_LOCAL_URL||process.env.REACT_APP_BACKEND_APP_API_URL}/api/v1/seller/CleaningEssentials/update/?prodId=${defaultVal._id}&hasImagesChange=${hasImagesChange}`, {
                    method: "PATCH",
                    headers: {
            ...
            if (defaultVal === undefined) {
                ...
                const response = await fetch(`${process.env.REACT_APP_BACKEND_APP_API_LOCAL_URL||process.env.REACT_APP_BACKEND_APP_API_URL}/api/v1/seller/CleaningEssentials/add`, {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": `Bearer ${localStorage.getItem('token')}`
                            ...
                            <form onSubmit={handlesubmit} method='post' encType="multipart/form-data" style={{ width: "100%" }} >
                                ...
                                <FormGroup sx={{ width: "400px" }}>
                                    <FormControl sx={{ width: "400px" }}>
                                        ...
                                        >
                                            <MenuItem value={"Lizol"}>Lizol</MenuItem>
                                            <MenuItem value={"Harpic"}>Harpic</MenuItem>
                                    ...
                                    <FormControl sx={{ width: "400px" }}>
                                        ...
                                        <Select
                                            ...
                                            onChange={handleChange}
                                        >
                                            <MenuItem value={"Liquid-Refill"}>Liquid Refill</MenuItem>
                                            <MenuItem value={"Liquid-Bottle"}>Liquid Bottle</MenuItem>
                                    ...
                                    <FormControl sx={{ width: "400px" }}>
                                        ...
                                        <Select
                                            variant="standard"
                                            labelId="useFor-name-label"
                                            id="use-For-name"
                                            name="useFor"
                                            sx={{ margin: 2, textAlign: 'left' }}
                                            value={product.useFor}
                                            onChange={handleChange}
                                        >
                                            <MenuItem value={"Utensils Cleaning"}>Utensils Cleaning</MenuItem>
                                            <MenuItem value={"Floor Cleaning"}>Floor Cleaning</MenuItem>
                                            <MenuItem value={"Toilet Cleaning"}>Toilet Cleaning</MenuItem>
