...
export default function CameraImgDisplayComponent(props) {
                    ...
                    >
                        ...
                        >
                            ...
                            <CardActions sx={{ display: "flex", flexDirection: { xs: "row", sm: "row" }, alignItems: { xs: "center" }, justifyContent: { sm: "center" } }}>
                                ...
                                <Button variant='contained' sx={{ backgroundColor: "#ff9f00",fontSize:"small" }} onClick={()=>{addToCard('Electronics',props.ProductCategory, data._id)}}>
