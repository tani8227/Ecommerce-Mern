...
export default function CameraImgComponentForDetailsPage(props) {
        ...
        <Box padding={0}   >
            <Grid container sx={{ xs: { display: 'flex', flexWrap: "nowrap" }, justifyContent: "center", backgroundColor:"white"}} >
                {fridgeData && fridgeData.map((ele, index) => (
                    <Grid container sx={{ display: "flex", flexDirection: { xs: "column", sm: "row", flexWrap: "nowrap" }, justifyContent: { xs: "center", md: "space-between" }, alignItems: { xs: "center" ,sm:"self-start" }, borderTop: "1px solid lightgrey" ,padding:{xs:1, sm:0} }} >
                        <Grid key={ele._id} item xs={12} sm={3} padding={0} sx={{ display: "flex",  border:{xs :"1px solid lightgrey", sm :"none"}, flexDirection: { xs: "column", sm: "row" }, justifyContent: { xs: "center", md: "space-evenly" }, alignItems: { xs: "flex-start" } }}>
                        ...
                        <Grid key={ele._id} item xs={10} sm={5} padding={0} sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, justifyContent: { xs: "center", md: "space-evenly" }, alignItems: { xs: "center" }, }}>
                            <Link to={`/Appliances/${props.ProductCategory}/${ele._id}`} style={{ textDecoration: "none" }} >
                                <Item square elevation={0}  >
                                    ...
                                    {/* <Typography variant='h6' color={'black'} sx={{ padding: 0, margin: 0, textAlign: "left", display:{xs:"block", sm:"none" } }} >
                                        {`${ele.companyName} ${ele.capacity} ${ele.defrostingType} ${ele.type} ${ele.color}`}
                                    </Typography> */}
                                    {/* <Box sx={{ display: "flex" }}> */}

                                    {/* <Typography variant='h4' sx={{ color: "black", padding: 0, margin: 0, textAlign: "left", display: { xs: "block", sm: "none" } }}>
                                            &#8377;0.0
                                    ...
                                    <Box sx={{ display: "flex" }}>
                                        ...
                                        {/* <Typography variant='span' sx={{ color: "green", padding: 0, margin: 0, textAlign: "left", display:{xs:"block", sm:"none" } }}><del>{ele.price}</del></Typography> */}
                                        {/* <Typography variant='span' sx={{ color: "green", padding: 0, margin: 0, textAlign: "left", display:{xs:"block", sm:"none" } }}>100% off</Typography> */}
                                    </Box>
                        ...
                        <Grid key={ele._id} item xs={3} padding={0} sx={{ display: { xs: "none", sm: "flex" }, flexDirection: { xs: "column", sm: "row" }, justifyContent: { xs: "center", md: "space-evenly" }, alignItems: { xs: "center" },  }}>
                            <Link to={`/Appliances/${props.ProductCategory}/${ele._id}`} style={{ textDecoration: "none" }}>
