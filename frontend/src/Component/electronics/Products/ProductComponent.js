...
import LaptopImgComponent from './laptop/LaptopImgComponent.js';
import PrinterImgComponent from './printer/PrinterImgComponent.js';
import CameraImgComponent from './camera/CameraImgComponent.js';
                    ...
                    <Box sx={{ overflowX: "auto", backgroundColor:"white" , width:"100%" ,}} className="gridRowScrollBar" >
                        <Grid container spacing={0} marginTop={0} sx={{ backgroundColor: "white", borderTop: "1px solid lightgrey", flexWrap: 'nowrap', width: { xs: "fit-content", md: "100%" } }}>
                            <Grid item xs={12} padding={1} sx={{ display: "flex", justifyContent: "space-evenly", width: "100%",  }}>
                                ...
                                {props.ProductCategory==='Laptop'&& <LaptopImgComponent data={ele} ProductCategory={props.ProductCategory} />}
                                {props.ProductCategory==='Printer'&& <PrinterImgComponent data={ele} ProductCategory={props.ProductCategory} />}
                                {props.ProductCategory==='Camera'&& <CameraImgComponent data={ele} ProductCategory={props.ProductCategory} />}
